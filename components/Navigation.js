...
const Navigation = () => {
    ...
    return (
        <nav className='flex flex-1 items-center justify-center gap-5  bg-red-50 py-4 p-4 z-40  sticky top-0'>
            ...
            <div className='lg:grow mx-5 py-5'>
                ...
                <ul className='DESKTOP-MENU hidden  space-x-8 lg:flex gap-y-9  flex-1 justify-end '>
                    <li>
                        <a href=''>Home</a>
                    </li>
                    <li>
